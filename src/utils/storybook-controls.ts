...
export const colorsVariantsOptions = [
  'primary',
  'secondary',
  'tertiary',
  'quaternary',
...
export const RemProps = {
  $lgRem: {
    control: 'number',
    description:
      'Escolher tamanho em px, que é convertido em rem para responsividade em telas maiores'
  },
  $mdRem: {
    control: 'number',
    description:
      'Escolher tamanho em px, que é convertido em rem para responsividade em telas médias'
  },
  $smRem: {
    control: 'number',
    description:
      'Escolher tamanho em px, que é convertido em rem para responsividade em telas menores'
  }
}
...
export const colorsVariants = {
  ...
  $darkTheme: {
    ...
    options: colorsVariantsOptions,
    description:
      'Escolher cor do texto do botão exclusivamente para tema escuro'
  },
  $lightTheme: {
    control: 'select',
    options: colorsVariantsOptions,
